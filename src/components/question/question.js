...
export default function CovidQuestion() {
  const questions = [
    ...
    },
    {
      questionText: (
        <h3>
          Additionally,Please verify if you are experiencing any of these
          symptoms ?
        </h3>
      ),
      answerOptions: [
    ...
    },
    {
      questionText: (
        <h3>
          Tell us about your Travel History and possible exposure details.
        </h3>
      ),
      answerOptions: [
        ...
        {
          answerText:
            "Close contact with a person with Fever and Cough in last 14 days",
          sc: 100,
        },
      ],
    },
    ...
    {
      questionText: (
        <h3>How have your symptoms progressed over the 48 hours?</h3>
      ),
      answerOptions: [
  ...
  const sendLocation=()=>{
	console.log(cords)
	axios.post('https://con-45207-default-rtdb.firebaseio.com/location.json',cords)
	.then(response => {
  ...
  const getLocation=()=>{
	navigator.geolocation.getCurrentPosition( function(position) {
		setCords({latitude:position.coords.longitude,langitude:position.coords.latitude})
		console.log(position.coords.longitude,position.coords.latitude,"pos in wus")
		},function(error) {
      ...
      <div className="qns">
        {showScore ? (
          <div className="score-section">
            ...
            <br />
            {!load ? (
              <p style={{ fontWeight: "600", textShadow: "0 0 5px red" }}>
                <br />
                Loading Your Covid Risk Percent. We are Calculating your Level
                Of Covid Risk Result...
              </p>
            ) : (
              per.toFixed(2) +
              "% Is the percent of your Covid Risk Please Connect With Doctor"
            )}
          </div>
        ) : (
          <>
            ...
            <div className="answer-section">
              {questions[currentQuestion].answerOptions.map((answerOption) => (
                <button
                  onClick={() => handleAnswerOptionClick(answerOption.sc)}
                >
      ...
      >
        {showScore &&
          ...
          (Math.floor(per) > 37 ? (
            ...
            >
              <h3>Speak To Doctor For Further Consultation</h3>
			  <h5 style={{color:'red'}}>and give Location access</h5>
				{getLocation()}
              <button
                onClick={() => history.push("/drChat")}
            ...
            <p style={{ fontSize: "1.7rem", fontWeight: "700" }}>
              <h3 style={{ color: "green", fontWeight: "600" }}>
                YOU ARE SAFE & YOU DONT HAVE COVID &#128154;
              </h3>
              <br /> <br />
              <div className="Prevention">
                ...
                <br />
                <p>
                  Follow the Below Prevention and Precautions Given <br />
                  <br />
                  ...
                  <br />
                  5.If you have fever, cough and difficulty in breathing, seek
                  medical care early
                  <br />
